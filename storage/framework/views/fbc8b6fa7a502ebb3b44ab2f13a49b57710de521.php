    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select id="my-who" class="form-control">
                                    ...
                                    <?php $__currentLoopData = \App\Tmfsales::where('sales_calls',1)->where('Visible',1)->orWhereIn('ID',[1,53,104,115])->orderBy('ID','desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tmfsales): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="mb-2" id="prospect-answers" style="max-height: 100px;overflow-x: hidden;overflow-y: auto;border: 1px solid #aaa;padding: 7px;background: #fcead3"></div>
                <div class="row">
                    <div class="col-md-12">
...
</div><!-- /.modal --><?php /**PATH /var/www/html/in.trademarkfactory.com/resources/views/booking-applications/email-to-client-modal.blade.php ENDPATH**/ ?>