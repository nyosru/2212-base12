                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select id="from" class="form-control">
                                    <?php $__currentLoopData = $tmfsales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tmfsale_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tmfsale_row->ID); ?>"
                                                <?php if($tmfsale_row->ID==Auth::user()->ID): ?> selected <?php endif; ?>><?php echo e($tmfsale_row->FirstName); ?> <?php echo e($tmfsale_row->LastName); ?></option>
...
<?php /**PATH /var/www/html/in.trademarkfactory.com/resources/views/email-forms/payments-calendar.blade.php ENDPATH**/ ?>