                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-xs-12">
                                    <div class="about block text-center">
                                        ...
                                        <p>Quisque sit amet libero purus. Nulla a dignissim quam. In hac habitasse
                                            platea
                                            dictumst.
                                        </p>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div id="portfolio" class="row wow fadeInUpQuick" data-wow-delay="0.8s">
                                <div class="col-lg-4 col-md-6 col-xs-12 mix marketing planning">
                                    <div class="portfolio-item">
                                        <div class="portfolio-img">
                                            <img src="{{ asset('/billiard/img/portfolio/img1.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="portfoli-content">
                                            <div class="sup-desc-wrap">
                                                <div class="sup-desc-inner">
                                                    <div class="sup-link">
                                                        <a class="left-link" href="#"><i
                                                                class="fa fa-link"></i></a>
                                                        <a class="right-link" href="#"><i
                                                    ...
                                                    <div class="sup-meta-wrap">
                                                        ...
                                                        <p class="sup-description">Lorem ipsum dolor sit amet,
                                                            consectetur
                                ...
                                <div class="col-lg-4 col-md-6 col-xs-12 mix branding planning">
                                    <div class="portfolio-item">
                                        <div class="portfolio-img">
                                            <img src="{{ asset('/billiard/img/portfolio/img2.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="portfoli-content">
                                            <div class="sup-desc-wrap">
                                ...
                                <div class="col-lg-4 col-md-6 col-xs-12 mix branding research">
                                    <div class="portfolio-item">
                                        <div class="portfolio-img">
                                            <img src="{{ asset('/billiard/img/portfolio/img3.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="portfoli-content">
                                            <div class="sup-desc-wrap">
                                ...
                                <div class="col-lg-4 col-md-6 col-xs-12 mix marketing research">
                                    <div class="portfolio-item">
                                        <div class="portfolio-img">
                                            <img src="{{ asset('/billiard/img/portfolio/img4.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="portfoli-content">
                                            <div class="sup-desc-wrap">
                                ...
                                <div class="col-lg-4 col-md-6 col-xs-12 mix marketing planning">
                                    <div class="portfolio-item">
                                        <div class="portfolio-img">
                                            <img src="{{ asset('/billiard/img/portfolio/img5.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="portfoli-content">
                                            <div class="sup-desc-wrap">
                                ...
                                <div class="col-lg-4 col-md-6 col-xs-12 mix planning research">
                                    <div class="portfolio-item">
                                        <div class="portfolio-img">
                                            <img src="{{ asset('/billiard/img/portfolio/img6.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="portfoli-content">
                                            <div class="sup-desc-wrap">
            ...
            @if (1 == 2)
                ...
                <section id="pricing" class="section-padding">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="section-title wow fadeInDown animated" data-wow-delay="0.3s">Pricing Table
                                </h2>
                            </div>
                        </div>
                        <div class="row">
            ...
            <section id="contact" class="contact-form section-padding">
                ...
                @if (1 == 2)
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="section-title wow fadeInDown animated" data-wow-delay="0.3s">Contact Us
                                </h2>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-xs-12">
                                ...
                                <div class="contact-info">
                                    ...
                                    <a href="#"><i
                                            class="lni-tab icons cyan-color contact-info-icon"></i>www.uideck.com</a>
