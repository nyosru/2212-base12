...
<head>
    ...
    @section('style')
        <style>
            header {
                padding: 30px 20px;
                background-color: rgba(200, 190, 110, 0.5);
            }
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <a href="/" class="btn">Первая</a>
                    <a href="{{ route('job.live.index') }}" class="btn">Текущие пироги</a>
                    <a href="{{ route('job.cooperativ.index') }}" class="btn">Кооперативы</a>
                    <a href="/client" class="btn">Клиенты</a>
                    <a href="/pays" class="btn">Платежи</a>
                    <a href="{{ route('job.contract.index') }}" class="btn">Контракты</a>
